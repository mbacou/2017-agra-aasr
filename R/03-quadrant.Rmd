...
table_options(HTMLcaption="(#tab:tab2) Est. Characteristics of Farm Holdings below 4 ha across Quadrants (2012/13, percent)")
...
table_options(HTMLcaption="(#tab:tab3) Land Assets of Farm Holdings below 4 ha across Quadrants (2012/13, ha)")
...
table_options(HTMLcaption="(#tab:tab4) Est. Production, Sales, and Income of Farm Holdings below 4 ha across Quadrants (2012/13, Cedis)")
html(tabular(Variable*(Mean+Q25+Q50+Q75)~Heading()*By*Heading()*Stat*Heading()*identity*Format(digits=1, big.mark=",", scientific=F),
  data=tmp), rmarkdown=T)
