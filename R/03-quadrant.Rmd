...
In this section we combine results from the farm typology developed in [Section 3](./typology-of-farm-holdings.html) with the spatial dimensions outlined above (FAO/GAEZ agricultural suitability and market access using IFPRI/HarvestChoice travel time to nearest **50K** market).
