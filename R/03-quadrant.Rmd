...
```{r, fig.cap="Areas of Low/High Agricultural Suitability (Ghana, 1980-2011)", out.width="380px"}

print(spplot(crop(glues, g2), col.regions=c("#ffffff", pal.ndvi_anom(255)),
  xlab=list("Agricultural Suitability (GLUES 1980-2011)", cex=.9)),
  split=c(1,1,2,1), more=T)

print(spplot(g2[g2$svyCode=="gha-glss6",], "seg_suit_glues", col="grey60", lwd=.2, col.regions=pal.ndvi_anom(2),
  xlab=list("Low/High Suitability across Districts (GLSS6, GLUES)", cex=.9)),
  split=c(2,1,2,1), more=F)
