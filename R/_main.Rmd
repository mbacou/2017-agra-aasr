...
output:
  ...
  bookdown::word_document2:
    reference_docx: "/home/mbacou/Google Drive/X-Files/templates/rmarkdown.docx"
...
opts_chunk$set(comment=NA, warning=F, message=F, echo=F, base.url="../docs",
  dev="svg", fig.path="fig/", fig.width=7, fig.height=3.8,
  dev.args=list(
    png=list(pointsize=10, family="Roboto Condensed", res=300), 
    svg=list(family="Roboto Condensed", antialias="subpixel")))
