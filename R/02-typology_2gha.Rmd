...
# Cultivated area
# See discussion below, we settle for IFPRI for the first 2 waves and RIGA for the last one
...
```{r, bplota, fig.cap="Cultivated Area (ha). Source: IFPRI 2016"}
...
```{r, bplotb, fig.cap="Farm Size (ha). Source: IFPRI 2016"}
...
```{r, bplotc, fig.cap="Operated Area (ha). Source: FAO/RIGA"}
...
In the following classification we use **option #1** (IFPRI cultivated area) for GLSS6 and GLSS5 and **option #3** (FAO/RIGA operated area) for GLSS4.
