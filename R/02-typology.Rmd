...
* $agrwge$ wage employement in agriculture
* $nonagrwge$ wage employement in non-farm sectors
* $selfemp$ non-farm self employement
...
pander(tabular((`Income Diversification`=D)~(`Crop Commercialization`=C)*Heading()*identity*Heading()*(as.character(clas)), data=tmp),
  ...
  caption="(#tab:tabclas) Household Classification")
...
pander(tmp[, .SD, .SDcols=c(1,3:8)], split.table=Inf,
  justify="crrrrrr", round=2, big.mark=",", keep.trailing.zeros=T,
  caption="(#tab:riga) RIGA Income Aggregates, NGHS 2012/2013 (Rural Households)")

```

All income aggregates are net of expenses, but for this study gross crop and livestock sales and gross farm and non-farm incomes would be preferable. These are derived in the codes below.
...
pander(tabular(Heading()*noaggross_clas~Format(big.mark=",")*Heading()*croparea_clas*Heading()*cropsales_clas,
  data=ghs), split.table=Inf, justify="crrrrrrrrr", emphasize.strong.cols=1, emphasize.rownames=F,
  caption="(#tab:countsa) Count of Observations across Classes of Farm Households")

pander(tabular(Heading()*noaggross_clas~Format(big.mark=",")*Heading()*croparea_2ha*Heading()*cropsales_clas,
  data=ghs), split.table=Inf, justify="crrrrrr",
  emphasize.strong.cols=1, emphasize.rownames=F,
  caption="(#tab:countsb) Count of Observations across Classes of Farm Households (below/above 2 ha)")

pander(tabular(Heading()*noaggross_clas~Format(big.mark=",")*Heading()*croparea_4ha*Heading()*cropsales_clas,
  data=ghs), split.table=Inf, justify="crrrrrr",
  emphasize.strong.cols=1, emphasize.rownames=F,
  caption="(#tab:countsc) Count of Observations across Classes of Farm Households (below/above 4 ha)")
...
plot(svytable(~croparea_4ha+noaggross_clas, ghs.svy.shf), main=NA, las=2,
  ylab="Cultivated Area", xlab="Off-Farm Income 3-class")
plot(svytable(~croparea_4ha+class9, ghs.svy.shf), main=NA, las=2,
  ylab="Cultivated Area", xlab="Categories 9-class")
...
pander(tabular(Heading()*noaggross_clas*(mean+SE)~Heading()*croparea_4ha*Heading()*cropsales_clas*Heading()*Format(digits=0, nsmall=1, scientific=F)*identity,
  data=tmp), justify="crrrrrrr", split.tables=Inf,
  emphasize.rownames=F, emphasize.italics.rows=c(2,4,6), emphasize.strong.cols=1,
  caption="(#tab:tab1) Est. Proportions of Farm Holdings across Categories")
...
pander(tabular(
  ...
  caption="(#tab:tab2a) Crop Commercialization for Farms below/above 4 ha (percent, '000 LCU)")
...
pander(tabular(
  ...
  data=tmp),
  emphasize.italics.cols=c(4,6), split.table=Inf,
  caption="(#tab:tab2b) Off-Farm Income for Farms below/above 4 ha (percent, '000 LCU)")
...
pander(tabular(
  ...
  data=tmp)[, -seq(2,18,2)],
  justify="ccrrrrrrrrr", split.table=Inf, emphasize.rownames=F,
  caption="(#tab:tab3) Sources of Agricultural Income for Small Farm Households across Categories ('000 LCU)")
...
pander(tabular(
  ...
  data=tmp)[, -seq(2,18,2)],
  justify="ccrrrrrrrrr", split.table=Inf, emphasize.rownames=F,
  caption="(#tab:tab3a) Sources of Agricultural Income for Small Farm Households across Categories (percent)")
...
pander(tabular(
  ...
  data=tmp)[, -seq(2,18,2)],
  justify="ccrrrrrrrrr", split.table=Inf, emphasize.rownames=F,
  caption="(#tab:tab3b) Land and Livestock Assets of Small Farm Households across Categories (ha, TLU)")
...
pander(tabular(
  ...
  data=tmp)[, -seq(2,18,2)],
  justify="ccrrrrrrrrr", split.table=Inf, emphasize.rownames=F,
  caption="(#tab:tab4) Demographics of Small Farm Households across Categories")
...
pander(tabular(
  ...
  data=tmp)[, -seq(2,18,2)],
  justify="ccrrrrrrrrr", split.table=Inf, emphasize.rownames=F,
  caption="(#tab:tab5) Parcels and Input Uses for Small Farm Households across Categories (percent)")
...
pander(tabular(
  ...
  data=tmp)[, -seq(2,18,2)],
  justify="ccrrrrrrrrr", split.table=Inf, emphasize.rownames=F,
  caption="(#tab:tab6) Poverty Incidence in Small Farm Households across Categories (PPP, percent)")
