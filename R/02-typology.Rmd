...
html(tabular(Heading()*noaggross_clas~Format(digits=0, big.mark=",")*Heading()*croparea_clas*Heading()*cropsales_clas,
  data=ghs))

table_options(HTMLcaption="(#tab:countsb) Count of Observations across Classes of Farm Households (below/above 2 ha)")
html(tabular(Heading()*noaggross_clas~Format(digits=0, big.mark=",")*Heading()*croparea_2ha*Heading()*cropsales_clas,
  data=ghs))

table_options(HTMLcaption="(#tab:countsc) Count of Observations across Classes of Farm Households (below/above 4 ha)")
html(tabular(Heading()*noaggross_clas~Format(digits=0, big.mark=",")*Heading()*croparea_4ha*Heading()*cropsales_clas,
  data=ghs))
...
plot(svytable(~croparea_4ha+cropsales_clas, ghs.svy.shf), main=NA, las=2, col=(1:6)*6,
  ylab="Cultivated Area", xlab="Crop Commercialization 3-class")
plot(svytable(~croparea_4ha+noaggross_clas, ghs.svy.shf), main=NA, las=2, col=(1:6)*6,
  ylab="Cultivated Area", xlab="Off-Farm Income 3-class")
plot(svytable(~croparea_4ha+class9, ghs.svy.shf), main=NA, las=2, col=(1:6)*6,
...
table_options(HTMLcaption="(#tab:tab1) Est. Proportions of Farm Holdings across Categories")
...
table_options(HTMLcaption="(#tab:tab2b) Off-Farm Income for Farms below/above 4 ha (percent, '000 LCU)")
html(tabular(
  Variable*(Mean+Q25+Q50+Q75)~Heading()*By*Heading()*Stat*Heading()*Format(big.mark=",", nsmall=2, digits=0)*identity,
  data=tmp))
...
table_options(HTMLcaption="(#tab:tab3) Sources of Agricultural Income for Small Farm Households across Categories ('000 LCU)")
html(tabular(
...
table_options(HTMLcaption="(#tab:tab3a) Sources of Agricultural Income for Small Farm Households across Categories (percent)")
html(tabular(
...
table_options(HTMLcaption="(#tab:tab3b) Land and Livestock Assets of Small Farm Households across Categories (ha, TLU)")
html(tabular(
  Variable*(Mean+Q25+Q50+Q75)~Heading()*By*Heading()*Stat*Heading()*identity*Format(digits=1, big.mark=",", scientific=F),
  data=tmp)[, -seq(2,18,2)])
