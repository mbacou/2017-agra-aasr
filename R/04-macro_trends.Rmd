...
# rmarkdown::render("./R/04-macro_trends.Rmd", "word_document", output_dir="./out/MB/tmp")
...
```{r agg-gdp, fig.cap="Regional Trends in GDP per Capita (1990-2015) Source: WDI.", fig.height=2}
...
```{r agg-yield, fig.cap="Regional Trends in Cereal Yield (1990-2015) Source: WDI.", fig.height=2}
...
include_graphics("../out/MB/2017-agra-aasr_RUTT_ts (corrected).svg", dpi=300)
