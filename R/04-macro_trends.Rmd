...
dt.group <- dt[, .(
  ...
  EA.PRD.AGRI.KD = sum(, na.rm=T)/sum(, na.rm=T)
), by=.(Region, year)]
...
```{r agg-ag, fig.cap="Regional Trends in GDP per Capita and Cereal Yield (1990-2015) Source: WDI.", out.height="400px", out.width="790px"}
...
```{r agg-gdp, fig.cap="Regional Trends in Sectoral Value Added (1990-2015) Source: WDI.", out.height="400px", out.width="790px", dev="png"}
