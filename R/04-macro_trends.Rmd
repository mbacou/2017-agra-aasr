...
# 
# ggsave("../out/MB/2017-agra-aasr_RUTT_ts (corrected).svg", width=6, heigh=4, units="in")

include_graphics("./figs/agg-rutt-1.png")

```

The custom regional aggregation used in the above graphs are given here.
