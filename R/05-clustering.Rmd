...
Below are pair-wise scatter plots across all covariates (cultivated area, sales, and income variables) colored by region.
...
Below are descriptive characteristics for the **sample** of farm households across the resulting **k=5** clusters. Population statistics across clusters are at the bottom of this page.
...
```{r gha-clust-fig, fig.cap="Est. Proportions of Farm Holdings across Clusters and Farm Types (k=5, all farm households)", fig.height=4}

plot(svytable(~clust_pam5+class5, gha.svy.farm[["gha6"]]), 
  main=NA, las=2, cex.axis=1, col=viridis(5),
  ylab=NA, xlab="5-class Farm Types across Clusters (k=5, below 4 ha)")
...
html(tabular(Heading("Cluster")*Factor(clust_pam5)*(mean+CI)~Heading("Proportions")*identity,
