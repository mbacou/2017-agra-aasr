...
pander(tabular(
  Variable*(Mean+Q25+Q50+Q75)~Heading()*By*Heading()*Stat*Heading()*as.integer*Format(big.mark=","),
  data=tmp), 
...
pander(tabular(
  Variable*(Mean+Q25+Q50+Q75)~Heading()*By*Heading()*Stat*Heading()*identity*Format(digits=0, nsmall=2),
  data=tmp), 
  justify="ccrrrrrr", emphasize.italics.cols=c(4,6,8), split.table=Inf,
