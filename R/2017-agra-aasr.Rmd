...
<p class="bg-warning">DRAFT, DO NOT USE OR CITE.</p>
--------------------------------------------------------------------------------------
...
pander(tabular(Heading()*noaggross_clas~Format(big.mark=",")*Heading()*croparea_2ha*Heading()*cropsales_clas,
  ...
  emphasize.strong.cols=1, emphasize.rownames=F,
  caption="Tab. Count of Observations across Classes of Farm Households (below/above 2 ha)")

pander(tabular(Heading()*noaggross_clas~Format(big.mark=",")*Heading()*croparea_4ha*Heading()*cropsales_clas,
  data=ghs), split.table=Inf, justify="rrrrrrr", 
  emphasize.strong.cols=1, emphasize.rownames=F,
  caption="Tab. Count of Observations across Classes of Farm Households (below/above 4 ha)")
...
```{r fig2a, fig.cap="Fig. Est. Proportions of Farm Holdings across Categories"}
