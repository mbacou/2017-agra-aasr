...
par(mfrow=c(1,2), mar=c(5,1,4,2))
plot(svytable(~cropsales_clas+croparea_4ha, ghs.svy.shf), main=NA,
  ylab=list("Cultivated Area", cex=.8), 
  xlab=list("Crop Commercialization", cex=.8))
plot(svytable(~noaggross_clas+croparea_4ha, ghs.svy.shf), main=NA,
  ylab=list("Cultivated Area", cex=.8), 
  xlab=list("Off-Farm Income", cex=.8))

par(mfrow=c(1,1), mar=c(5,2,1,2))
plot(svytable(~class9+croparea_4ha, ghs.svy.shf), main=NA, las=3,
  ylab=list("Cultivated Area", cex=.8), 
