...
tmp <- factor(c("low", "medium", "high"), ordered=T)
...
par(mfrow=c(1,2))
plot(svytable(~cropsales_clas+croparea_4ha, ghs.svy.shf), main=NA, las=2,
  ylab=list("Cultivated Area", cex=.8), 
  xlab=list("Crop Commercialization", cex=.8))
plot(svytable(~noaggross_clas+croparea_4ha, ghs.svy.shf), main=NA, las=2,
  ylab=list("Cultivated Area", cex=.8), 
