...
pander(tabular(
  ...
  data=tmp), justify="ccrrrrrr",
  emphasize.italics.cols=c(4,6,8), split.table=Inf,
  caption="Tab. Demographics of Small Farm Households across Categories (ha, TLU, percent)")
...
pander(tabular(
  ...
  data=tmp), justify="ccrrrrrr",
  emphasize.italics.cols=c(4,6,8), split.table=Inf,
  caption="Tab. Parcels and Input Uses for Small Farm Households across Categories (ha, TLU, percent)")
...
tmp <- svyCrossTab(list(~pcexp_ppp_m, ~foodexp_ppp_m, ~nfoodexp_ppp_m,
  ~I(poor_ppp1*100), ~I(poor_ppp2*100), ~I(povgap_ppp1), ~I(povgap_ppp2*100),
...
pander(tabular(
  ...
  data=tmp), justify="ccrrrrrr",
  emphasize.italics.cols=c(4,6,8), split.table=Inf,
  caption="Tab. Poverty Incidence in Small Farm Households across Categories (ha, TLU, percent)")
