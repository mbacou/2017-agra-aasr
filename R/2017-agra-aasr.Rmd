...
pander(tabular(
  Variable*(Mean+Q25+Q50+Q75)~Heading()*By*Heading()*Stat*Heading()*Format(nsmall=2, digits=0, big.mark=",")*identity,
  data=tmp),
...
pander(tabular(
  ...
  data=tmp),
  emphasize.italics.cols=c(4,6,8), 
  caption="Tab. Characteristics of Small Farm Households across Categories (ha, TLU, percent)")
