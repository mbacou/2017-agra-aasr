...
knitr::opts_chunk$set(comment=NA, warning=F, message=F, echo=F, base.url="../docs",
  ...
  dev.args=list(png=list(pointsize=10, family="Roboto Condensed", res=300), svg=list(family="Roboto Condensed", antialias="subpixel")))
...
# Default options
table_options(htmloptions(justification="c", head=FALSE, pad=TRUE))
