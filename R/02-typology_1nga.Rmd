...
```{r nga-fig1e, fig.cap="Crop Commercialization by Age and Gender"}
...
```{r nga-fig1g, fig.cap="Income Diversification by Age and Gender"}
...
```{r nga-fig1h, fig.cap="Crop Commercialization and Income Diversification along Market Access"}
...
```{r nga-fig1i, fig.cap="Crop Commercialization and Income Diversification vs. Distance to Nearest Road"}
